...
public class SpeakerController {
	...
	public String addTalk(@PathVariable Long id, String title, String description, Integer durationId, Long genreId,
			Long tagId, String iFrame) {
		Speaker speaker = speakerService.fetchSpeaker(id);
		...
		Talk talkToAdd = new Talk(title, description, Duration.getDurationById(durationId), speaker);
